...
const blogs = [
  {
    ...
    date: "May 9, 2023",
    title:
      "Revolutionize testing with zAI: AI-powered test case tool backed by GPT-4o",
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center text-center mt-12">
          <Link
            ...
            variant="secondary"
            className="bg-[#ED2C92] flex items-center justify-center hover:border-[#3a1d67] text-white rounded-[8px]"
          >
